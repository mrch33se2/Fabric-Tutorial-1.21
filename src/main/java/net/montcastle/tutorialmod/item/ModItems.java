package net.montcastle.tutorialmod.item;
...
import net.montcastle.tutorialmod.item.custom.ChiselItem;
import net.montcastle.tutorialmod.item.custom.HammerItem;
...
public class ModItems {
    ...
    public static final Item PINK_GARNET_SHOVEL = registerItem("pink_garnet_shovel",
            new ShovelItem(ModToolMaterials.PINK_GARNET, new Item.Settings()
                    .attributeModifiers(ShovelItem.createAttributeModifiers(ModToolMaterials.PINK_GARNET, 1, -3.0f))));
